...
**Compatibility:** EmDash 0.37.0, Astro 7.3.1, React 19 and Lingui 5. English and German interfaces; automatic or forced text direction. MIT licensed. This is a native plugin, installed through your site's configuration; it is not a sandbox marketplace bundle.
...
In your EmDash site, install the resulting `emdash-plugin-relink-0.1.0.tgz`. Existing EmDash installations should already have the peer dependencies. Keep `@emdash-cms/admin` at 0.37.0 and Lingui on major version 5.

```sh
pnpm add /path/to/emdash-plugin-relink-0.1.0.tgz
```
